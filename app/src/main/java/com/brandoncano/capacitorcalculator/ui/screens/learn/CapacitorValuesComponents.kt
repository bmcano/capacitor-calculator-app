    ...
    Column(
        ...
        tableData.forEach { pair ->
            ...
            Row(Modifier.fillMaxWidth()) {
                TableCell(text = id, weight = column1Weight, style = textStyleBody().onSurfaceVariant())
                TableCell(text = text, weight = column2Weight, style = textStyleBody().onSurfaceVariant())
            }
